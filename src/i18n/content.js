...
const hero = {
  ...
  de: {
    tagline: "Entwickelt in Deutschland",
    description:
      "Beauftragen Sie uns für kurzfristige, wiederkehrende oder langfristige Projekte — wir entwickeln hochwertige Websites für deutsche Unternehmen und Kunden und liefern präzise Ergebnisse, die Ihre Erwartungen übertreffen.",
    cta: "JETZT ANFRAGEN",
  },
};
    ...
    projects: [
      {
        ...
        hours: "120+",
        pages: "40+",
        liveUrl: "https://khaki-gemstone-37sf.vercel.app/",
        repoUrl: "https://github.com/FaiziCodeSpace/khaki-gemstone.git",
      ...
      },
      {
        ...
        hours: "80+",
        pages: "20+",
        liveUrl: "https://khaki-gemstone-37sf.vercel.app/agent-hub",
        repoUrl: "https://github.com/FaiziCodeSpace/khaki-gemstone.git",
      ...
      },
      {
        ...
        hours: "20+",
        components: "15+",
        liveUrl: "https://portfolio-gooddeveloper24.vercel.app/",
        repoUrl: "https://github.com/FaiziCodeSpace/Portfolio.git",
...
const pricing = {
  individual: {
    ...
    modal: {
      ...
      preferedSlotLabel: "Preferred Slot",
  ...
  team: {
    ...
    modal: {
      ...
      topMsg: "Fill in your details and I'll get back to you within 24 hours.",
      nameLabel: "Full Name",
      emailLabel: "Email",
      phoneLabel: "Phone",
      websiteLabel: "Website",
      messageLabel: "Message",
      preferedSlotLabel: "Preferred Time",
      ...
      msgPlaceholder: "Describe your project, requirements, or ideas...",
      submitLabel: "Send Message",
      privacyWarning: "Your information is private and will never be shared.",
      noCommitmentMsg: "No commitment. Cancel anytime."
    },
  },
  ...
  de: {
    ...
    modal: {
      ...
      bookCallTitle: "Termin vereinbaren",
      topMsg: "Füllen Sie Ihre Daten aus und wir melden uns innerhalb von 24 Stunden bei Ihnen.",
      nameLabel: "Vollständiger Name",
      emailLabel: "E-Mail",
      phoneLabel: "Telefon",
      websiteLabel: "Website",
      messageLabel: "Nachricht",
      preferedSlotLabel: "Wunschtermin",
      ...
      emailPlaceholder: "max.mustermann@example.de",
      subjectPlaceholder: "Worum geht es?",
      websitePlaceholder: "https://ihre-website.de",
      msgPlaceholder: "Beschreiben Sie Ihr Projekt, Ihre Anforderungen oder Ihre Ideen...",
      submitLabel: "Nachricht senden",
      "privacyWarning": "Ihre Daten sind privat und werden niemals weitergegeben.",
      "noCommitmentMsg": "Keine Verpflichtung. Jederzeit kündbar."
    },
  },
};
...
const contact = {
  individual: {
    ...
    errorNetwork: "Network error. Please try again.",
    contactEmail: "faizanwebdev1@gmail.com",
    contactPhone: "+92 315 070-6255",
    namePlaceholder: "John Doe",
    emailPlaceholder: "john.doe@example.com",
    subjectPlaceholder: "What's this about?",
    msgPlaceholder: "Tell me about what's in your mind...",
    privacyWarning: "Your info is private and never shared.",
    "weReadEveryMessage": "I read every message personally."
  },
  team: {
    badge: "Get in touch",
    heading: "Let's build something great.",
    ...
    emailPlaceholder: "john.doe@example.com",
    subjectPlaceholder: "What's this about?",
    msgPlaceholder: "Tell us about what's in your mind...",
    privacyWarning: "Your info is private and never shared.",
    "weReadEveryMessage": "We read every message personally."
  },
  de: {
    ...
    errorNetwork: "Netzwerkfehler. Bitte versuchen Sie es erneut.",
    contactEmail: "Gerken.energie@gmail.com",
    contactPhone: "+49 176 47793058",
    namePlaceholder: "Max Mustermann",
    emailPlaceholder: "max.mustermann@example.de",
    subjectPlaceholder: "Worum geht es?",
    msgPlaceholder: "Beschreiben Sie Ihr Projekt, Ihre Anforderungen oder Ihre Ideen...",
    "privacyWarning": "Ihre Daten sind privat und werden niemals weitergegeben.",
    "weReadEveryMessage": "Wir lesen jede Nachricht persönlich."
  },
};
