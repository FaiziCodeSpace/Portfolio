...
function Work() {
  const t = useContent("work")
  const workCard = t.phases
    ...
    <>
      ...
      <section id="process" className='w-full bg-secondary rounded-0 md:rounded-[104px] mt-[clamp(80px,12vw,350px)]'>
        <div className='flex justify-between items-start'>
          <h2 className='font-bebas font-medium text-[clamp(42px,8vw,80px)] pl-10 md:pl-20 pt-16 md:pt-24 text-text-primary'>
            {/* 1. Pull the header directly from the parent object 't' instead of mapping arrays */}
            {t.header || "Our Process"} <span className='text-brand'>?</span>
          </h2>
